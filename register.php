...
define("MIN_USER", 6);
define("MIN_PWD", 6);
define("DEFAULT_PAGE", "registered.php");

main("Administrator Registration");
...
<tr>
  <td><?php echo $f->formatOnError('username','Username') ?></td>
  <td><?php echo $f->makeTextInput('username') ?></td>
</tr>
<tr>
  <td><?php echo $f->formatOnError('password','Password') ?></td>
  <td><?php echo $f->makePassword('password') ?></td>
</tr>
<tr>
  <td><?php echo $f->formatOnError('password2','Confirm password') ?></td>
